    ...
    bool newHighScore)
{
    ...
    std::string averageCut = string_format("<color=%s><size=4>Average Cuts</size></color>\n<color=%s><size=8>%.2f</size></color>", colorTitle.c_str(), colorValue.c_str(), result->averageCutScoreForNotesWithFullScoreScoringType);

    std::string goodCuts = string_format("<color=%s><size=4>Good Cuts</size></color>\n<color=%s><size=8>%d</size></color>", colorTitle.c_str(), colorValue.c_str(), result->goodCutsCount);

    std::string badCuts = string_format("<color=%s><size=4>Bad Cuts</size></color>\n<color=%s><size=8>%d</size></color>", colorTitle.c_str(), colorValue.c_str(), result->badCutsCount);

    std::string missedCuts = string_format("<color=%s><size=4>Missed Cuts</size></color>\n<color=%s><size=8>%d</size></color>", colorTitle.c_str(), colorValue.c_str(), result->missedCount);
